...
def loadDataSet(filename): # 读取数据
    ...
    colors1 = '#00CED1'
    colors2 = '#DC143C'
    plt.scatter(x_1, y_1, c=colors1, label='co=1')
    plt.scatter(x_2, y_2, c=colors2, label='co=0')
    plt.legend()
    plt.grid("on")
    plt.show()
...
if __name__=='__main__':
    filename_traindata='./data1/train_data1.txt'
    filename_testdata='./data1/test_data1.txt'
